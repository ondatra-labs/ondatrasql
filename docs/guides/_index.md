...
- [Fetch Data from APIs](/guides/fetch-data-from-apis/): ingest data from REST APIs using lib functions
- [Create a Lib Function](/guides/create-a-blueprint/): build a lib function for API ingestion or outbound sync
