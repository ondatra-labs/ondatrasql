...
// TestSchemaVersion_Is4 pins the schema version. Bump only when
...
func TestSchemaVersion_Is4(t *testing.T) {
	if SchemaVersion != 4 {
		t.Errorf("SchemaVersion = %d, want 4 (parser.events_missing_columns removed in v4)", SchemaVersion)
	}
}
