...
func TestMaterializeSCD2_NoTempTable(t *testing.T) {
	...
	_, err := runner.materializeSCD2(model,"tmp_nonexistent", true, "", "", "hash", "backfill", result, time.Now(), trackedRunOpts{})
	if err == nil {
...
func TestMaterializePartition_NoTempTable(t *testing.T) {
	...
	_, err := runner.materializeTracked(model, "tmp_nonexistent", true, "", "", "hash", "backfill", result, time.Now(), trackedRunOpts{})
	if err == nil {
...
func TestMaterialize_UnknownKind(t *testing.T) {
	...
	_, err := runner.materialize(model, "tmp_unknown_kind", true, nil, "", "hash", "backfill", result, time.Now(), trackedRunOpts{})
	if err == nil {
		t.Fatal("expected error")
	}
...
func TestMaterialize_EnsureSchemaError(t *testing.T) {
	...
	_, err := runner.materialize(model, "tmp_schema_err", true, nil, "", "hash", "backfill", result, time.Now(), trackedRunOpts{})
	if err == nil {
...
func TestMaterialize_MergeGetColumnsError(t *testing.T) {
	...
	_, err := runner.materialize(model, "tmp_merge_err", false, nil, "", "hash", "incremental", result, time.Now(), trackedRunOpts{})
	if err == nil {
		t.Fatal("expected error")
	}
...
func TestMaterializeSCD2_CommitError_Backfill(t *testing.T) {
	...
	_, err = runner.materializeSCD2(model,"tmp_scd2_commit", true, "", "", "hash", "backfill", result, time.Now(), trackedRunOpts{})
	if err == nil {
...
func TestMaterializeSCD2_DetectChangesError(t *testing.T) {
	...
	result := &Result{Target: model.Target}
	_, err := runner.materializeSCD2(model,"tmp_scd2_detect", true, "", "", "hash", "backfill", result, time.Now(), trackedRunOpts{})
	if err != nil {
	...
	_, err = runner.materializeSCD2(model,"tmp_scd2_detect", false, "", "", "hash", "incremental", result2, time.Now(), trackedRunOpts{})
	if err == nil {
...
func TestMaterializePartition_CommitError_Backfill(t *testing.T) {
	...
	_, err = runner.materializeTracked(model, "tmp_part_commit", true, "", "", "hash", "backfill", result, time.Now(), trackedRunOpts{})
	if err == nil {
		t.Fatal("expected commit error from missing ducklake_set_commit_message")
	}
...
func TestMaterializePartition_UpdateError(t *testing.T) {
	...
	result := &Result{Target: model.Target}
	_, err := runner.materializeTracked(model, "tmp_part_upd", true, "", "", "hash", "backfill", result, time.Now(), trackedRunOpts{})
	if err != nil {
		t.Fatalf("backfill failed: %v", err)
	}
	...
	result2 := &Result{Target: model.Target}
	_, err = runner.materializeTracked(model, "tmp_part_upd", false, "", "", "hash", "incremental", result2, time.Now(), trackedRunOpts{})
	if err == nil {
		t.Fatal("expected error on incremental with missing temp table")
	}
}
...
func TestMaterializeSCD2_CountChangesError(t *testing.T) {
	...
	result := &Result{Target: model.Target}
	_, err := runner.materializeSCD2(model,"tmp_scd2_cnt", true, "", "", "hash", "backfill", result, time.Now(), trackedRunOpts{})
	if err != nil {
		t.Fatalf("backfill failed: %v", err)
	}
	...
	result2 := &Result{Target: model.Target}
	_, err = runner.materializeSCD2(model,"tmp_scd2_cnt", false, "", "", "hash2", "incremental", result2, time.Now(), trackedRunOpts{})
...
func TestMaterializeSCD2_IncrementalCommitError(t *testing.T) {
	...
	_, err = runner.materializeSCD2(model,"tmp_scd2_incr", false, "", "", "hash", "incremental", result, time.Now(), trackedRunOpts{})
	if err == nil {
		t.Fatal("expected commit error from missing ducklake_set_commit_message")
	}
}
...
func TestMaterializePartition_IncrementalCommitError(t *testing.T) {
	...
	_, err = runner.materializeTracked(model, "tmp_part_incr", false, "", "", "hash", "incremental", result, time.Now(), trackedRunOpts{})
	if err == nil {
		t.Fatal("expected commit error from missing ducklake_set_commit_message")
	}
...
func TestMaterializeSCD2_TableExistsCheckError(t *testing.T) {
	...
	_, err = runner.materializeSCD2(model,"tmp_x", true, "", "", "hash", "backfill", result, time.Now(), trackedRunOpts{})
	if err == nil {
...
func TestMaterializeSCD2_GetSourceColumnsError(t *testing.T) {
	...
	_, err = runner.materializeSCD2(model,"tmp_scd2_cols", true, "", "", "hash", "backfill", result, time.Now(), trackedRunOpts{})
	if err == nil {
...
func TestMaterializePartition_TableExistsCheckError(t *testing.T) {
	...
	_, err = runner.materializeTracked(model, "tmp_x", true, "", "", "hash", "backfill", result, time.Now(), trackedRunOpts{})
	if err == nil {
		t.Fatal("expected error from tableExistsCheck")
	}
	if !strings.Contains(err.Error(), "check table exists") {
...
func TestMaterialize_SchemaEvolutionError(t *testing.T) {
	...
	_, err := runner.materialize(model, "tmp_schema_evo", false, badChange, "", "hash", "incremental", result, time.Now(), trackedRunOpts{})
	if err == nil {
...
func TestMaterialize_CaptureSchemaError(t *testing.T) {
	...
	_, err = runner.materialize(model, "tmp_capture_err", true, nil, "", "hash", "backfill", result, time.Now(), trackedRunOpts{})
...
func TestMaterializeSCD2_CountChangesError_Direct(t *testing.T) {
	...
	_, err = runner.materializeSCD2(model,"tmp_scd2_cnt_d", false, "", "", "hash", "incremental", result, time.Now(), trackedRunOpts{})
	if err == nil {
...
func TestMaterialize_MergeGetColumnsSuccess(t *testing.T) {
	...
	_, err := runner.materialize(model, "tmp_merge_ok", false, nil, "", "hash", "incremental", result, time.Now(), trackedRunOpts{})
	if err != nil {
...
func TestMaterialize_EnsureSchemaAfterCount(t *testing.T) {
	...
	_, err = runner.materialize(model, "tmp_ens_err", true, nil, "", "hash", "backfill", result, time.Now(), trackedRunOpts{})
	if err == nil {
		t.Fatal("expected error")
	}
}
